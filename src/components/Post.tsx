...
function Post({ author, publishedAt, content }: PostProps) {
    ...
    // Evento disparado ao enviar o form == evento do form
    function handleCreateNewComment(event: FormEvent) {
        event.preventDefault()


        // Copia todos os dados ja existentes na variavel
        setComments([...comments, newCommentText]);
        setNewCommentText('');
    }

    // onChange == Deve se passar um generics com o tipo do textarea -- generics funcionam como parametros
